          ...
          <Tabs defaultValue="all" className="w-full" onValueChange={setCategory}>
            <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-8 gap-6">
              <div className="flex items-center gap-2 bg-secondary rounded-lg p-2 w-full md:w-auto">
                <button onClick={() => setCategory("all")} className={`px-3 py-1.5 rounded-md text-xs md:text-sm font-medium transition-colors flex-1 md:flex-none ${category === "all" ? "bg-primary text-white" : "hover:bg-secondary-foreground/10"}`}>
                  All
                </button>
                <button onClick={() => setCategory("longterm")} className={`px-3 py-1.5 rounded-md text-xs md:text-sm font-medium transition-colors flex-1 md:flex-none ${category === "longterm" ? "bg-primary text-white" : "hover:bg-secondary-foreground/10"}`}>
                  Long Term
                </button>
                <button onClick={() => setCategory("shortterm")} className={`px-3 py-1.5 rounded-md text-xs md:text-sm font-medium transition-colors flex-1 md:flex-none ${category === "shortterm" ? "bg-primary text-white" : "hover:bg-secondary-foreground/10"}`}>
                  Short Term
                </button>
                <button onClick={() => setCategory("holiday")} className={`px-3 py-1.5 rounded-md text-xs md:text-sm font-medium transition-colors flex-1 md:flex-none ${category === "holiday" ? "bg-primary text-white" : "hover:bg-secondary-foreground/10"}`}>
                  Holiday
                </button>
              </div>
